...
I recently participated in a hackathon organised by EU's anti-disinformation task force where they gave us access to their data base. The data base consists of all disinformation cases the group has collected since it started in 2015. Their data can also be browsed online on their web page [www.euvsdisinfo.eu](https://euvsdisinfo.eu). I built a small [R package](https://github.com/corriebar/euvsdisinfoR) that makes it easier to download the data from their API (it seems though that the API is currently not updated as regularly as their web page) if you want to check out the data yourself. The data contains more than 7000 cases of disinformation, mostly news articles and videos, that were collected and debunked by the EUvsDisinfo project. Their data does not contain the articles or videos themselves but only an URL to where the piece originally appeared together with a short summary of the claim made, why it's not true, and some other meta data, such as language and countries targeted. So I went ahead and scraped the original articles, both the raw html and just a text version, extracted from the html. If you want to play with the data yourself, it's all uploaded on [kaggle](https://www.kaggle.com/corrieaar/disinformation-articles). For this post, I use both the html-files and the csv-file containing the meta data.
