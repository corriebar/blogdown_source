---
title: 'Analyzing the European Election: Looking at the Candidates'
author: Corrie
date: '2019-05-21'
categories:
  - R
...
_Die Linke_, the left party, has exactly 50% female and male candidates, whereas the Green (_GRÜNE_) party and the _SPD_ have a very slight female bias. All three parties are rather left-leaning. The other three bigger parties, all more conservative, have a male bias that is especially strong for the _FDP_ and _AfD_. The _AfD_ is far-right so I'm not surprised by their poor gender ratio but I didn't expect the _FDP_ to do so poorly as well. I expected them be more on the same line as _CDU/CSU_, around 40% of females.
